...
mkdir -p logs data/tokenized_voicemark exp/tts_valle_neumark_control
...
CONFIG_PATH="${1:-${SCRIPT_DIR}/config_tts_valle_control.json}"
...
echo "=========================================================="
echo " Starting VALL-E NeuMark Control Training Pipeline        "
echo " Host:        $(hostname)                                 "
echo " Time:        $(date)                                     "
...
# 5. Step 2: Start NeuMark Control Training
echo "=========================================================="
echo " Starting NeuMark Control Watermark Training               "
echo " Config: ${CONFIG_PATH}                                   "
echo "=========================================================="
...
if [ "${NUM_GPUS}" -gt 1 ]; then
  ...
  accelerate launch \
    ...
    --dynamo_backend no \
    tts_valle_control_train.py --config "${CONFIG_PATH}"
else
